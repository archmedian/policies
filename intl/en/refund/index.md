...
**This policy applies to any product created and owned by {{ owner_legal_name }}. That includes {{ product_list }}. There are [some nuances with HEY](hey/index.md) because its subscriptions are on an annual basis only.*
